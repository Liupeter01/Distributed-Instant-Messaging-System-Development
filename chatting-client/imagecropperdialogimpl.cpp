...
ImageCropperDialogImpl::ImageCropperDialogImpl(const std::size_t _width,
                                               ...
                                               QWidget *parent)
    : QDialog(parent), ui(new Ui::ImageCropperDialogImpl), m_width(_width),
      m_height(_height), m_outputPixmap(output_image) {
  ui->setupUi(this);
...
ImageCropperDialogImpl::~ImageCropperDialogImpl() { delete ui; }
