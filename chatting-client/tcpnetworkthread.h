...
private:
  void registerSignal() {
    connect(chatting_thread, &QThread::finished, chatting_thread, &QObject::deleteLater);
    connect(resource_thread, &QThread::finished, resource_thread, &QObject::deleteLater);
  }
