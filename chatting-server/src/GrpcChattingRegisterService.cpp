...
gRPCGrpcRegisterChattingService::getPeerChattingServerLists(
...
message::PeerResponse gRPCGrpcRegisterChattingService::getPeerGrpcServerLists(
    const std::string &cur_name) {
...
message::StatusResponse gRPCGrpcRegisterChattingService::registerGrpcServer(
    const std::string &name, const std::string &host, const std::string &port) {
...
message::StatusResponse gRPCGrpcRegisterChattingService::chattingServerShutdown(
