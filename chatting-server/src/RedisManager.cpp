...
redis::RedisConnectionPool::RedisConnectionPool(const std::size_t _timeout, 
...
void redis::RedisConnectionPool::roundRobinChecking() {
          ...
          for (; !expectedStubs && currentStubs < expectedStubs; currentStubs++) {
                    ...
                    try{
                              ...
                              spdlog::warn("[Redis DataBase]: Error = {} Restarting Connection...", e.what());
...
bool 
redis::RedisConnectionPool::connector(const std::string& _ip, 
                                                            const  std::string& _passwd, 
