...
message::PeerResponse
gRPCResourcesService::getPeerResourcesGrpcServerLists(const std::string& cur_name){
          ...
          grpc::Status status = raii->get()->GetPeerResourceGrpcServerInfo(&context, request, &response);
...
message::GrpcStatusResponse
gRPCResourcesService::registerResourcesGrpcServer(const std::string& name, const std::string& host,
          const std::string& port){
